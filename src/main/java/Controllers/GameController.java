...
import main.java.Models.Options;
...
public class GameController {
    ...
    void init(Options options) throws PlayerColorException {
        ...
        blackPawn = new Image("main/resources/Images/black_pawn.png");
        blackRook = new Image("main/resources/Images/black_rook.png");
        blackKnight = new Image("main/resources/Images/black_knight.png");
        blackBishop = new Image("main/resources/Images/black_bishop.png");
        blackQueen = new Image("main/resources/Images/black_queen.png");
        blackKing = new Image("main/resources/Images/black_king.png");

        whitePawn = new Image("main/resources/Images/white_pawn.png");
        whiteRook = new Image("main/resources/Images/white_rook.png");
        whiteKnight = new Image("main/resources/Images/white_knight.png");
        whiteBishop = new Image("main/resources/Images/white_bishop.png");
        whiteQueen = new Image("main/resources/Images/white_queen.png");
        whiteKing = new Image("main/resources/Images/white_king.png");


        dot = new Image("main/resources/Images/dot.png");
